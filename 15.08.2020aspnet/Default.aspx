<%@ Page Title="" Language="C#" MasterPageFile="~/Ogretmen.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="_15._08._2020aspnet.Default" %>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%#Eval("NUMARA")%></td>
                        <td><%#Eval("OGRNAME")%></td>
                        <td><%#Eval("OGRSURNAME")%></td>
                        <td><%#Eval("OGRTELEPHONE")%></td>
                        <td><%#Eval("OGRMAIL")%></td>
                        <td><%#Eval("OGRSIFRE")%></td>
                        <td>
